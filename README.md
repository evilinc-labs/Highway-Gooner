...
## Dependencies & Mods
- [Fabric loader v0.17.2](https://fabricmc.net/) or later.
- [Meteor Client build 1.21.8 - 69](https://meteorclient.com/), found in their archive.
- [Baritone 1.15.0](https://github.com/cabaletta/baritone/releases/).  Requires both api and standalone fabric jars. 
